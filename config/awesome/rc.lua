...
local taglist_buttons = gears.table.join(
    ...
    awful.button({ modkey }, 3,
        function(t) if client.focus then
...
client.connect_signal( "manage", function(c) c.shape = function( cr, w, h ) gears.shape.rounded_rect( cr, w, h, 5 ) end end) -- rounded corner
-- }}}
