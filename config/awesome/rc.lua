...
-- screenshot
screenshot_dir = "~/Images/Screenshots/scrot_$(date +%F-%H%M%S).jpg"
screenshot_fullscreen = "maim -u " .. screenshot_dir
...
globalkeys = gears.table.join(
    ...
    awful.key({modkey, "Shift"}, "Print", function() awful.spawn.with_shell(screenshot_window) end),
    awful.key({modkey, "Ctrl"}, "Print", function() awful.spawn.with_shell(screenshot_selected) end),

    -- power
    awful.key({modkey}, "End", function () awful.spawn.with_shell("systemctl suspend") end),
    awful.key({modkey, "Ctrl"}, "End", function() awful.spawn.with_shell("reboot") end),
    awful.key({modkey, "Shift"}, "End", function() awful.spawn.with_shell("poweroff") end),
...
client.connect_signal("request::titlebars", function(c)
    ...
    awful.titlebar(c, {size = 20}) : setup {
        ...
        { -- Right
            wibox.layout.margin(awful.titlebar.widget.floatingbutton(c), 2, 2, 2, 2),
            wibox.layout.margin(awful.titlebar.widget.maximizedbutton(c), 2, 2, 2, 2),
            awful.titlebar.widget.stickybutton(c),
            wibox.layout.margin(awful.titlebar.widget.ontopbutton(c), 2, 2, 2, 2),
            wibox.layout.margin(awful.titlebar.widget.closebutton(c), 2, 2, 2, 2),
            layout = wibox.layout.fixed.horizontal()
        },
        layout = wibox.layout.align.horizontal
    }
